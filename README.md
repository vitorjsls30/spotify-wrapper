...
[![Coverage Status](https://coveralls.io/repos/github/vitorjsls30/vs-spotify-wrapper/badge.svg)](https://coveralls.io/github/vitorjsls30/vs-spotify-wrapper)
...
## Installation
```sh
$ npm install vs-spotify-wrapper --save
```
...
import SpotifyWrapper from 'vs-spotify-wrapper';
...
// using a method
var albums = spotify.search.artists('Choosen Artist');
```
